...
<template>
  <div>
    <div class="bg-light-grey pt-6 pb-6">
      <h1
        ...
        data-cy="homeview_main_title"
      >
        NOTRE RAISON D'ÊTRE
      </h1>
      <p class="ryman-eco font-bold text-4xl text-center my-10" data-cy="homeview_subtitle">
        RETROUVER CEUX QUI SE SONT
        <span class="relative">
          <span class="block absolute -inset-1 -skew-y-3 bg-dark-green" aria-hidden="true"></span>
          <span class="relative text-white">ÉGARÉS</span>
        </span>
      </p>
    </div>
